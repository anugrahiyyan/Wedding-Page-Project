...
import { createInvoice, toggleInvoiceStatus, deleteInvoice } from '@/app/lib/actions';
                                    ...
                                    <td>
                                        <div className={styles.actionButtons}>
                                            ...
                                            <form action={async () => {
                                                ...
                                                <button className={styles.deleteBtn} style={{ background: '#dc2626', color: 'white', border: 'none', padding: '0.25rem 0.75rem', borderRadius: '4px', cursor: 'pointer', fontSize: '0.875rem' }} title="Delete Permanently">Delete</button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
