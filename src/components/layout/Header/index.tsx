        ...
        <div className='flex justify-between items-center gap-2 w-full'>
          <div>
            <Link href='/' className="text-2xl font-bold tracking-tighter flex items-center gap-2">
              <span className={`${isHomepage ? sticky ? "text-primary" : "text-white" : "text-primary"}`}>Rabikuu</span>
            </Link>
          </div>
          <div className='flex items-center gap-2 sm:gap-6'>
            ...
            <div className={`hidden md:block`}>
              <Link href='https://wa.me/6281230826731' target="_blank" className={`text-base text-inherit flex items-center gap-2 border-r pr-6 ${isHomepage
                ? sticky
        ...
        <div className="flex flex-col h-full justify-between">
          ...
          <div className='flex flex-col gap-1 my-16 text-white'>
            ...
            <Link href="#" className='text-base sm:text-xm font-medium text-inherit hover:text-primary'>
              hello@undanganrabikuu.my.id
            </Link>
            <Link href="https://wa.me/6281230826731" target="_blank" className='text-base sm:text-xm font-medium text-inherit hover:text-primary'>
              +62 812-3082-6731{' '}
            </Link>
          </div>
        </div>
